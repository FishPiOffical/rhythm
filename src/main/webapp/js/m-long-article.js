...
var MLongArticle = {
    ...
    bindEvents: function () {
        ...
        $(document).on('click', function (e) {
            if (!$(e.target).closest('.m-long-article-bar').length &&
                !$(e.target).closest('.m-long-article-panel').length) {
                $('#mLongArticlePanel').removeClass('show');
            }
        });
    },
    ...
    toggleSettings: function () {
        $('#mLongArticlePanel').toggleClass('show');
    },
    ...
    setTheme: function (theme, save) {
        ...
        // 更新按钮状态
        $('.m-long-article-theme-btn').removeClass('active');
        $('.m-long-article-theme-btn').each(function () {
    ...
    setFontSize: function (delta, save) {
        ...
        // 更新显示
        $('#mLongArticleFontSize').text(newSize + 'px');
