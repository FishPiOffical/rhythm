            ...
            switch (data.type) {
                ...
                case 'discussChanged':
                    ...
                    let discussHtml = "<div class='newDiscussNotice' style='color: rgb(50 50 50);margin-bottom: 12px;text-align: center;display: none;'>" +
                        ...
                        newDiscuss +
                        "</a></div>";
                    if (typeof ChatRoom !== 'undefined' && typeof ChatRoom.appendAndMaybeScroll === 'function') {
                        ChatRoom.appendAndMaybeScroll(discussHtml, { animate: false });
                    } else {
                        $('#chats').append(discussHtml);
                    }
                ...
                case 'redPacketStatus':
                    ...
                    let html = "<div class='redPacketNotice' style='color: rgb(50 50 50);margin-bottom: 12px;text-align: center;display: none;'>" +
                        ...
                        "</div>";
                    if (typeof ChatRoom !== 'undefined' && typeof ChatRoom.appendAndMaybeScroll === 'function') {
                        ChatRoom.appendAndMaybeScroll(html, { animate: false });
                    } else {
                        $('#chats').append(html);
                    }
                ...
                case 'customMessage':
                    let message = "<div class='customNotice' style='color: rgb(118 118 118);margin-bottom: 12px;text-align: center;display: none;'>" +
                        data.message +
                        "</div>";
                    // 系统自定义消息视为最新消息，追加到底部并跟随滚动
                    if (typeof ChatRoom !== 'undefined' && typeof ChatRoom.appendAndMaybeScroll === 'function') {
                        ChatRoom.appendAndMaybeScroll(message, { animate: false });
                    } else {
