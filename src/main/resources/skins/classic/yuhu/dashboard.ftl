...
<div class="dashboard-container">
    <div class="dashboard-left">
        <div class="dashboard-box active">
            ...
            <div class="dashboard-content">
                <div class="dashboard-content-title">
                    作品管理
                    <span class="dashboard-content-btn" onclick="showAlert('createYuhu')">新建</span>
                </div>
        ...
        <div class="dashboard-alert createYuhu">

                <div class="dashboard-alert-title">
                    新建鱼乎
                     <div class="dashboard-alert-close" onclick="hideAlert('createYuhu')">
                        <svg><use xlink:href="#close"></use></svg>
                    </div>
                </div>
            <div class="yuhu-input-item">
                <div class="yuhu-input-label">名称:</div>
                <input class="yuhu-input" type="text"/>
            </div>
            <div class="yuhu-input-item">
                <div class="yuhu-input-label">标签:</div>
                <input class="yuhu-input" type="text"/>
            </div>
            <div class="yuhu-input-item">
                <div class="yuhu-input-label">介绍:</div>
                <textarea class="yuhu-input-textarea" lang="5"></textarea>
            </div>
            <div class="yuhu-input-item">
                <div class="yuhu-input-label">封面:</div>
                <input class="yuhu-input" type="file" accept="image/*"/>
            </div>
            <div class="yuhu-input-item">
