...
<!DOCTYPE html>
<html>
<head><@head title="鱼游管理 - ${symphonyLabel}"></@head><link rel="stylesheet" href="${staticServePath}/css/index.css?${staticResourceVersion}"></head>
<body>
<#include "../header.ftl">
<#assign sideHotArticles = sideHotArticles![]>
<div class="main"><div class="wrapper"><div class="content"><div class="module fish-game-admin">
    <div class="fish-game-admin__header"><div><h1>鱼游管理</h1><p>审核投稿，维护已收录鱼游。</p></div><div class="fish-game-admin__toolbar"><button class="fish-game-admin__button fish-game-admin__button--secondary" type="button" data-fish-game-export>导出 JSON</button></div></div>
