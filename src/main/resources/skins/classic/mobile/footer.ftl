...
<script src="${staticServePath}/js/profession${miniPostfix}.js?${staticResourceVersion}&amp;profession-ui-v20260804c"></script>
<script src="${staticServePath}/js/profession-profile${miniPostfix}.js?${staticResourceVersion}&amp;profession-ui-v20260804c"></script>
<script src="${staticServePath}/js/profession-settings-autosave${miniPostfix}.js?${staticResourceVersion}&amp;profession-ui"></script>
<#if algoliaEnabled>
...
<script>
    ...
    function ABDetected() {
        var adContainer = document.getElementsByClassName("wwads-cn")[0];
