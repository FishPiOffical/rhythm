...
<!DOCTYPE html>
<html><head><@head title="${fishGame.fishGameName?html}"></@head><link rel="stylesheet" href="${staticServePath}/css/mobile-base.css?${staticResourceVersion}"></head>
<body><#include "../header.ftl"><div class="main"><div class="content activity"><div class="module fish-game-detail">
...
</div></div></div><#include "../footer.ftl"><script>window.fishGameId='${fishGame.oId?html}'</script><script src="${staticServePath}/js/fish-game.js?${staticResourceVersion}"></script></body></html>
